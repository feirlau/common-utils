...
package {
    ...
    public class EditorComponentConfig extends Sprite implements IComponentConfig {
        [Embed(source='Comp.png', compression="true")]
        public static var Comp:Class;
        ...
        public function EditorComponentConfig() {
            load();
        }

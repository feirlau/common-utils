...
packages = ["encodings", "email", "django", "IPServicePython"]

project_name = "IPServiceApp"
...
# project files
project_path = "IPServicePython"
py2exe_data_files += add_path_tree( project_path, 'data' )
py2exe_data_files += add_path_tree( project_path, 'template' )
py2exe_data_files += add_path_tree( project_path, 'public_resources' )
py2exe_data_files += add_path_tree( project_path, 'static_resources' )

setup(
    version="1.0",
    description="IPService application by FeirLau",
    name="IPServiceApp",
